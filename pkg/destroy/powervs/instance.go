...
func (o *ClusterUninstaller) listInstances() (cloudResources, error) {
	...
	instances, err := o.instanceClient.GetAll(o.ServiceGUID, defaultTimeout)
	if err != nil {
...
func (o *ClusterUninstaller) destroyInstance(item cloudResource) error {
	...
	_, err = o.instanceClient.Get(item.id, o.ServiceGUID, defaultTimeout)
	if err != nil {
	...
	err = o.instanceClient.Delete(item.id, o.ServiceGUID, defaultTimeout)
	if err != nil {
...
func (o *ClusterUninstaller) destroyInstances() error {
	...
	if items = o.getPendingItems(instanceTypeName); len(items) > 0 {
		return errors.Errorf("Error: destroyInstances: %d items pending", len(items))
	}
	return nil
}
