...
resource "random_string" "joiner" {
  depends_on = [ibm_is_lb.load_balancer_int, ibm_is_lb.load_balancer, ibm_is_lb_listener.machine_config_listener, ibm_is_lb_pool.machine_config_pool, ibm_is_lb_pool.api_pool, ibm_is_lb_pool.api_pool_int]
